 ...
 * @author hc
 */
public class CustomMapRepresentation implements Serializable {
	...
	Set<String> NodesWithAgents;

	private SerializableSimpleGraph<String, MapAttribute> sg;//used as a temporary dataStructure during migration


	public CustomMapRepresentation() {
		...
		NodesWithAgents = new HashSet<String>();
...
//		System.out.println("path from " + idFrom + " to " + idTo);
		List<String> shortestPath=new ArrayList<String>();

		
		SerializableSimpleGraph<String, MapAttribute> s = this.getSerializableGraph();
		Iterator<String> it = NodesWithAgents.iterator();
		
		
		while(it.hasNext()) {

			String agent = it.next();
			if(idTo.equals(agent)) return shortestPath;
			
			if (this.g.getNode(agent)!=null) this.g.removeNode(agent);
		}
	...
	public void markNodeAsAgent(String idNode) {
		
		NodesWithAgents.add(idNode);
		
	}
	
	public void unmarkNodeAsAgent(String idNode) {


		NodesWithAgents.remove(idNode);
